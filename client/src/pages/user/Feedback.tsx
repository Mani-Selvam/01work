...
export default function Feedback() {
  ...
  const getStatusBadge = (feedback: Feedback) => {
    if (feedback.adminResponse) {
      return <span className="text-xs px-2 py-1 rounded-full bg-green-100 dark:bg-green-900 text-green-700 dark:text-green-300">Responded</span>;
    }
    return <span className="text-xs px-2 py-1 rounded-full bg-yellow-100 dark:bg-yellow-900 text-yellow-700 dark:text-yellow-300">Pending</span>;
  };
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      <div>
        ...
        <p className="text-sm sm:text-base text-muted-foreground mt-1">Share your feedback with Admin or Team Leader</p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Choose who will receive your feedback and share your thoughts</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="recipient-type">Send Feedback To</Label>
            <Select value={recipientType} onValueChange={(value: "Admin" | "TeamLeader") => setRecipientType(value)}>
              <SelectTrigger id="recipient-type" data-testid="select-recipient-type">
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
                ...
                <SelectItem value="TeamLeader" data-testid="option-team-leader">
                  <div className="flex items-center gap-2">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Track the status and responses to your feedback</CardDescription>
        </CardHeader>
        <CardContent>
          {loadingFeedbacks ? (
