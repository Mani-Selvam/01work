...
export default function Tasks() {
  ...
  useEffect(() => {
    ...
    const savedCompletedIds = localStorage.getItem('memberCompletedTaskIds');
  ...
  useEffect(() => {
    localStorage.setItem('memberCompletedTaskIds', JSON.stringify(Array.from(completedTaskIds)));
  }, [completedTaskIds]);
