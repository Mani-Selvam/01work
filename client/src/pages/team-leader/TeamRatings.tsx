    ...
    <div className="space-y-6">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground">Review team member performance ratings</p>
        </div>
      </div>
                    ...
                    <div>
                      ...
                      {latestRating ? (
                        <div className="flex items-center gap-2 mt-1">
                          {renderStars(getRatingValue(latestRating.rating))}
                ...
                {latestRating ? (
                  <div className="space-y-3">
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-sm">
                        {new Date(latestRating.createdAt).toLocaleDateString('en-US', {
                          year: 'numeric',
                          month: 'long',
                          day: 'numeric',
                        })}
                  ...
                  <div className="text-center py-6">
                    ...
                    <p className="text-sm text-muted-foreground">
                      This team member hasn't been rated yet
                    </p>
                  </div>
                )}
              </CardContent>
